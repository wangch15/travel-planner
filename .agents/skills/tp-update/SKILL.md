...
**這一條不因為「agent 量過沒有可見變化」而放寬。** 看起來很合理——引擎改了什麼、
對這趟有沒有影響，agent 確實可以去量。但那等於**模型自己給自己發許可**，而閘門二
存在的理由就是那個許可只能由人給。引擎更新一次可能帶進幾十個 commit，你量得到的
是你想到要量的那些。

**成本也沒有你想的高**：`npm run preview -- <slug> --lan` 把網址念給他，他在手機上
捲一次就好。他說「看起來一樣」也是一次有效的確認。
